...
- **Junyuan Fang**, Huimin Liu, Han Yang, Jiajing Wu*, Zibin Zheng, and C. K. Tse, "Mitigating the Structural Bias in Graph Adversarial Defenses", arXiv, 2025. [[arXiv]](https://arxiv.org/abs/2504.20848)
- **Junyuan Fang**, Han Yang, Haixian Wen, Jiajing Wu*, Zibin Zheng, and C. K. Tse, "Quantifying the Noise of Structural Perturbations on Graph Adversarial Attacks", arXiv, 2025. [[arXiv]](https://arxiv.org/abs/2504.20869)

# Journal and Conference Papers

- **Junyuan Fang**, Han Yang, Jiajing Wu*, Zibin Zheng, and C. K. Tse, "What Contributes More to the Robustness of Heterophilic Graph Neural Networks?", in IEEE Transactions on Systems, Man and Cybernetics: Systems (**TSMC**), 2025. [[Paper]](https://ieeexplore.ieee.org/abstract/document/10937261) [[Code]](https://github.com/alexfanjn/Impact-of-heterophilic-designs)
- Biwei Li, Dong Liu*, **Junyuan Fang**, Xi Zhang, and C. K. Tse, "Failure Propagation Graphs for Studying Cascading Failure Propagation in Power Networks", in IEEE Systems Journal (**ISJ**), 2025. [[Paper]](https://ieeexplore.ieee.org/document/10836957)
